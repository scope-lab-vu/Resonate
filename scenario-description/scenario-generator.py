...
#weather patterns to be generated
...
#scenario route to be generated from CARLA AD XML file
...
if __name__ == '__main__':
        simulation_run = int(input("enter the data file to store the results:"))#enter the simulation run number 0,1, 2....,N
        num_scenes = int(input("enter the number of scenes to run  in the simulation:"))#Enter number of scenes to be generated in the simulation run. 
