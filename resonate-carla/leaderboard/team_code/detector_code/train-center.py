...
# path to USB
USBPath = "/home/scope/Carla/autopilot_Carla_ad/sample_data/right/"
...
Working_folder = 'right-1024'#experiment
...
def CreateModels(n_latent=100, sample_enc=sample_func, beta=1, C=0):
    model = Sequential()
...
def train(X,autoencoder):
    ...
    callbacks_list = [EarlyStopping(monitor='val_loss', mode='min', patience=10, verbose=0),checkpoint, data]
